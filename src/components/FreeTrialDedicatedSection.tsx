        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 w-full text-center">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 space-y-2 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xs font-bold text-white"><BinaryText binaryClassName="text-white/10" leftBinary="01" rightBinary="10">ارسال پیام به پشتیبانی</BinaryText></h3>
              <p className="text-[11px] text-slate-400 leading-relaxed text-center">در اولین فرصت بعد از دریافت پیام اشتراک تست ویژه به همراه ساب هوشمند تحویلت می‌شه</p>
            </div>
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 space-y-2 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xs font-bold text-white"><BinaryText binaryClassName="text-white/10" leftBinary="01" rightBinary="10">نصب برنامه پیشنهادی</BinaryText></h3>
              <p className="text-[11px] text-slate-400 leading-relaxed text-center">برنامه v2box (برای موبایل) یا v2rayN (برای کامپیوتر) رو از طریق لینک‌های موجود توی سایت دانلود و لینک ساب هوشمندت رو داخلش بزن</p>
            </div>
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 space-y-2 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xs font-bold text-white"><BinaryText binaryClassName="text-white/10" leftBinary="01" rightBinary="10">تست بازی و وبگردی</BinaryText></h3>
              <p className="text-[11px] text-slate-400 leading-relaxed text-center">دکمه اتصال رو بزن و از کیفیت و سرعت بی‌حدوحصر لذت ببر!</p>
            </div>
          </div>
          {onScrollToSection && (
            <div className="text-center pt-2">
              <button onClick={() => onScrollToSection('apps')} className="text-xs text-pink-400 hover:text-pink-300 font-semibold inline-flex items-center justify-center gap-1.5 transition">
                <Download className="w-3.5 h-3.5" /><span>مشاهده و دانلود نرم‌افزارهای پیشنهادی (v2box و v2rayN)</span>
              </button>
            </div>
          )}
        </div>
