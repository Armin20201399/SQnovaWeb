  ...
  return (
    ...
    >
      ...
      <div className="w-full pt-2 flex items-center justify-center gap-2">
        ...
        {app.githubUrl && (
          <a href={app.githubUrl} target="_blank" rel="noreferrer" className="p-3.5 rounded-2xl bg-slate-900/80 hover:bg-slate-800/80 border border-white/10 text-slate-300 hover:text-white transition" title="لینک دانلود جایگزین / گیت‌هاب">
