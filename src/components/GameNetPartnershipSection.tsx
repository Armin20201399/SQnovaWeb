        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-purple-950/85 via-slate-900/95 to-pink-950/85 border border-purple-500/40 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-6 text-center lg:text-right">
          <div className="space-y-2 max-w-2xl text-center lg:text-right">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-white text-center lg:text-right">
              <BinaryText binaryClassName="text-pink-400/20" leftBinary="01" rightBinary="10">راه‌اندازی روتینگ ویژه گیم‌نت و گیم‌کلاب شما با منابع دلخواه و سرورهای اختصاصی</BinaryText>
            </h3>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-3 flex-shrink-0">
            <a id="gamenet-consultation-btn" href="https://t.me/ArminSQ" target="_blank" rel="noreferrer" className="whitespace-nowrap flex-shrink-0 px-7 py-3.5 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-bold text-xs sm:text-sm shadow-[0_10px_25px_rgba(236,72,153,0.4)] hover:scale-105 transition duration-300 flex items-center justify-center gap-2">
              <Send className="w-4 h-4 text-sky-200" /><span>ارتباط با پشتیبانی و دریافت مشاوره</span>
            </a>
          </div>
        </div>
      </div>
