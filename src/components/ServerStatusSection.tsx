...
const SERVER_NODES: ServerNodeStatus[] = [
  { id: 'se-apex', name: 'سوئد (استکهلم)', country: 'Sweden', flag: '🇸🇪', datacenter: 'APEX 10G Tier-3+', type: 'europe', status: 'online', uptime: '99.99%', packetLoss: '0.0%', protocolSupport: ['Hysteria 2', 'TCP Reality', 'xHTTP'], load: 'سبک' },
  { id: 'nl-ams', name: 'هلند (آمستردام)', country: 'Netherlands', flag: '🇳🇱', datacenter: 'Equinix AM4 Direct Fiber', type: 'europe', status: 'online', uptime: '100.0%', packetLoss: '0.0%', protocolSupport: ['Hysteria 2', 'TCP Reality', 'mKCP'], load: 'عادی' },
  { id: 'de-hetzner', name: 'آلمان (فالکنشتاین)', country: 'Germany', flag: '🇩🇪', datacenter: 'Hetzner Dedicated Enterprise', type: 'europe', status: 'online', uptime: '99.98%', packetLoss: '0.0%', protocolSupport: ['Hysteria 2', 'TCP Reality', 'xHTTP', 'mKCP'], load: 'عادی' },
  { id: 'tr-ist', name: 'ترکیه (استانبول)', country: 'Turkey', flag: '🇹🇷', datacenter: 'Turkcell Core Routing Hub', type: 'hub', status: 'online', uptime: '99.99%', packetLoss: '0.0%', protocolSupport: ['Hysteria 2', 'TCP Reality'], load: 'سبک' },
  { id: 'ir-shatel', name: 'شاتل (تهران)', country: 'Iran', flag: '🇮🇷', datacenter: 'Shatel Datacenter / MikroTik Core', type: 'iran', status: 'online', uptime: '100.0%', packetLoss: '0.0%', protocolSupport: ['MikroTik Hardware Routing', 'Intranet Bridge'], load: 'عادی' },
...
const ServerStatusSection = () => {
  return (
    <section id="status" className="cv-900 py-24 relative overflow-hidden bg-cyber-grid border-t border-white/10 text-center">
